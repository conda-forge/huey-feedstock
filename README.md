...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/huey-feedstock/blob/master/LICENSE.txt)

Summary: A little task queue for python

Development: https://github.com/coleifer/huey

Documentation: http://huey.readthedocs.org/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5257&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/huey-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `huey` can be installed with:

```
conda install huey
```

It is possible to list all of the versions of `huey` available on your platform with:
